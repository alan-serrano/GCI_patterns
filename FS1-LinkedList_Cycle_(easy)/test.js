...
describe('LinkedList Cycle (easy)', ()=> {
...
function tester(functionToTest, title='') {
    test(`${title} Linked List has no cycle`, () => {
        ...
        expect(functionToTest(head)).toEqual(false);
        
        head.next.next.next.next.next.next = head.next.next
        expect(functionToTest(head)).toEqual(true);
        
        head.next.next.next.next.next.next = head.next.next.next
        expect(functionToTest(head)).toEqual(true);
    });
    
    test(`${title} Head is null`, () => {
        expect(functionToTest(null)).toEqual(false);
    });
